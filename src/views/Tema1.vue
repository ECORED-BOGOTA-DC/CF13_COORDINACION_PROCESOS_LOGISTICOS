  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5.mb-lg-4
      .col-lg-8.col-xl-9.pe-lg-4.order-2.order-lg-1(data-aos="fade-right")
        p Cada persona que forma parte de la organización debe reconocer a la gestión del conocimiento, como un conjunto de estrategias, que abarcan una serie de actividades de las cuales se pueden identificar las siguientes:
    ...
    p.text-center.fw-bold.mb-5 Algunos aspectos fundamentales de la gestión moderna del talento humano se centran básicamente en 3 tipos de esfuerzos:
    ...
    .d-flex.flex-wrap.mb-5.mb-lg-4
      ...
      .col-lg-8.col-xl-9.ps-lg-4(data-aos="fade-right")
        ...
        p En este sentido, es necesario definir algunas variables fundamentales en la planeación estratégica del talento humano de la organización, como son:
    ...
    p.mb-5 Son varios los objetivos de la planificación estratégica, pero entre los más significativos se tienen:
    ...
    .container-100.py-2(
      ...
      .bloque-texto-g.bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5.mb-5
        .bloque-texto-g__img(
          :style="{'background-image': `url(${require('@/assets/curso/temas/tema1/img-21.jpg')})`}"
        )
        .bloque-texto-g__texto.p-4(data-aos="fade-right")
      ...
      p.mb-5 No todos los departamentos de RR.HH. son iguales en todas las empresas, ya que se deben adaptar a las necesidades y objetivos de la compañía de la que forman parte. A pesar de esto existen una serie de funciones y responsabilidades comunes en todos ellos, entre ellas encontramos las siguientes:
        ...
        .col-md.tarjeta.color-acento-botones.p-4.p-xl-5(style="background-color: #D8E4FD")
          ...
          ul
            ...
            li.d-flex.align-items-start
              img.pt-2.me-2(src="@/assets/curso/temas/tema1/decorador-2.svg" data-aos="fade-right" style="max-width: 11px; min-width: 11px")
              | Clima laboral.
    p.text-center Estas funciones y responsabilidades permiten mejorar la gestión del talento humano dentro de la organización en pro y desarrollo de la misma
</template>
